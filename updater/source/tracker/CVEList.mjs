...
CVEList.prototype = Object.assign({}, Emitter.prototype, {

	[Symbol.for('description')]: 'MITRE CVEList',
	[Symbol.toStringTag]:        'CVEList',

	connect: function() {

		// Don't cache CVEList files due to their corrupted state
		this.emit('connect');
	...
	disconnect: function() {
		...
		// TODO: If this.__state.git then close process?
